...
%---------------------------------------------------------------
\section{Cross-platformní a multi-platformní možnosti}
%---------------------------------------------------------------
...
Mezi hlavní výhody cross-platformního vývoje patří efektivita a rychlost vývoje díky sdílení kódu mezi platformami. Vývojáři mohou využít frameworky jako Flutter \cite{flutter-cross-platform}, React Native \cite{react-native-cross-platform} nebo Xamarin \cite{xamarin-cross-platform}, které umožňují psát kód v~populárních jazycích (např. JavaScript, TypeScript, Dart, C\#) a následně ho spouštět na různých platformách. Tento přístup také usnadňuje aktualizace a údržbu aplikací, protože změny se projeví na všech podporovaných platformách současně.
